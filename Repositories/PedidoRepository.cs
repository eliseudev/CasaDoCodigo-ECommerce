...
namespace CasaDoCodigo.Repositories
{
    public interface IPedidoRepository
    {
        ...
        UpdateQuantidaeResponse UpdateQuantidade(ItemPedido itemPedido);
    ...
    public class PedidoRepository : BaseRepository<Pedido>, IPedidoRepository
    {
        ...
        public Pedido GetPedido()
        {
            ...
            var pedido = dbSet.Include(p => p.Itens).ThenInclude(i => i.Produto).Include(p => p.Cadastro).Where(p => p.Id == pedidoId).FirstOrDefault();
        ...
        public UpdateQuantidaeResponse UpdateQuantidade(ItemPedido itemPedido)
        {
            ...
            if (itemPedidoDB != null)
            {
                ...
                return new UpdateQuantidaeResponse(itemPedidoDB, carrinhoViewModel);
            }
